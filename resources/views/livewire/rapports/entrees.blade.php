<div>
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
        <div>
            <flux:heading size="xl">Rapport des Entrées</flux:heading>
            <flux:text class="text-zinc-500 text-sm">Historique des réceptions de marchandises</flux:text>
        </div>
        <flux:badge color="green" size="lg" class="self-start sm:self-auto">Total : {{ $totalQuantite }} unités</flux:badge>
    </div>
            ...
            <tbody class="divide-y divide-zinc-100 dark:divide-zinc-800">
                ...
                <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                    ...
                    <td class="px-4 py-3 text-center">
                        <flux:badge color="green">+{{ $m->quantite }}</flux:badge>
                    </td>
                ...
                @empty
                <tr>
                    <td colspan="6" class="px-4 py-12 text-center text-zinc-400">Aucune entrée sur cette période.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <div class="block md:hidden space-y-3 mb-4">
        ...
        <div class="rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-4 shadow-sm space-y-3">
            <div class="flex justify-between items-start">
                ...
                <flux:badge color="green" size="sm">+{{ $m->quantite }}</flux:badge>
            </div>
            ...
            <div class="text-xs border-t border-zinc-100 dark:border-zinc-800 pt-2">
                <span class="block text-[10px] text-zinc-400 dark:text-zinc-500 uppercase font-medium">Motif / Réf</span>
